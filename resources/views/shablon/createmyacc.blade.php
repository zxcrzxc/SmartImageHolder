            ...
            <nav class="site-navigation position-relative text-right text-lg-center" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li><a href="{{route('loginPage')}}">Войти</a></li>
                  <li class="active"><a href="{{route('registrationPage')}}">Зарегистрироваться</a></li>
                @endif
              </ul>
            </nav>
          </div>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-7">
            <div class="row mb-5">
                ...
                <form action="{{route('registrationPagePost')}}" method="POST" enctype="multipart/form-data">
                @method('POST')
                @csrf 
                ...
                <label class="text-white">{{$msg}}</label>
                <div class="row form-group">
                  <div class="col-md-6">
                    <label class="text-white">Почта</label>
                    <input type="email" name="eMail" value="" class="form-control"required placeholder="Поле обязательно">
                  </div>
                  <div class="col-md-6 mb-3 mb-md-0">
                    <label class="text-white">Имя</label>
                    <input type="text" name="fname" value="" class="form-control"required placeholder="Поле обязательно">
                  </div>
                </div>
                <div class="row form-group">
                  <div class="col-md-6">
                    <label class="text-white">Фамилия</label>
                    <input type="text" name="sname" value="" class="form-control"required placeholder="Поле обязательно">
                  </div>
                  <div class="col-md-6 mb-3 mb-md-0">
                    <label class="text-white">Отчество</label>
                    <input type="text" name="tname" value="" class="form-control">
                  </div>
                </div>
                <div class="row form-group">
                  <div class="col-md-6">
                    <label class="text-white">Дата рождения</label>
                    <input type="date" name="birth_date" value="" class="form-control"required placeholder="Поле обязательно">
                  </div>
                  <div class="col-md-6 mb-3 mb-md-0">
                    <label class="text-white">Пароль</label>
                    <input type="password" name="password" value="" class="form-control"required placeholder="Поле обязательно">
                  </div>
                </div>
              <div class="row form-group">
                <div class="col-md-12">
                  <label class="text-white">Информация о себе</label> 
                  <textarea name="info" cols="30" rows="7" class="form-control" placeholder="Напишите здесь информацию о себе"></textarea>
                </div>
              </div>              
